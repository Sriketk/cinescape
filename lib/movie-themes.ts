...
export const movieThemes: Record<string, MovieTheme> = {
  default: {
    ...
    chatInput: {
      background: 'bg-gradient-to-br from-white/90 via-amber-50/80 to-orange-50/70',
      backdropBlur: true,
      border: 'border border-amber-200/30 hover:border-amber-300/50 focus-within:border-orange-300/60',
      ...
      focusBackground: 'focus-within:bg-gradient-to-br focus-within:from-white/95 focus-within:via-amber-50/90 focus-within:to-orange-50/80',
  ...
  moonlight: {
    ...
    chatInput: {
      background: 'bg-gradient-to-br from-slate-800/90 via-blue-900/80 to-cyan-900/70',
      backdropBlur: true,
      border: 'border border-cyan-400/30 hover:border-cyan-300/50 focus-within:border-cyan-200/60',
      shadow: 'shadow-lg shadow-cyan-500/20 md:shadow-2xl md:shadow-cyan-500/30',
      hoverShadow: 'hover:shadow-xl hover:shadow-cyan-500/40',
      focusBorder: 'focus-within:border-cyan-200/60',
      focusBackground: 'focus-within:bg-gradient-to-br focus-within:from-slate-800/95 focus-within:via-blue-900/90 focus-within:to-cyan-900/80',
